                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post"
                                    action="{{ route('admins.categories.update', \Illuminate\Support\Facades\Crypt::encryptString($category->id)) }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" id="status">
                                                <option value="1" @selected((string) old('staus', $category->status) === '1')>
                                                    {{ __('admin.edit_category.active') }}
                                                </option>
                                                <option value="0" @selected((string) old('staus', $category->status) === '0')>
