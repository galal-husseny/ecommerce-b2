                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admins.categories.show' , [\Illuminate\Support\Facades\Crypt::encryptString($category->id)])}}" class="btn btn-sm btn-success my-2 rounded-pill "> {{__('admin.all_categories.show')}} </a>
                                                <a href="{{route('admins.categories.edit' ,  \Illuminate\Support\Facades\Crypt::encryptString($category->id))}}" class="btn btn-sm btn-primary my-2  rounded-pill "> {{__('admin.all_categories.edit')}} </a>
                                                <form action="{{route('admins.categories.destroy' , [($category->id)])}}" method="post" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
