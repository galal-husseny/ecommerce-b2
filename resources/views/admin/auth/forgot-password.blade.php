    ...
    <div class="container d-flex justify-content-center m-t-150" style="margin-top: 150px">
        <div class="w-50 shadow p-3 mb-5 bg-body rounded">
            ...
            <div class="card-body register-card-body mb-4">
                <p class="mb-6">
                    {{ __('messages.admin.auth.message') }}
                </p>
                ...
                <form action="{{ route('admins.password.email') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn bg-dark btn-block rounded-pill hover:bg-primary-500"
                                style="background-color: black;">{{ __('messages.admin.auth.send_password_email_reset') }}</button>
                        </div>
                    </div>
                </form>
            </div>
