...
@section('title')
{{__('messages.frontend.about.about_title')}}
@endsection
...
@section('content')
    ...
    <section class="bg-img1 txt-center p-lr-15 p-b-92 m-t-100"
        ...
        <h2 class="ltext-105 cl0 txt-center">
            {{__('messages.frontend.about.about')}}
        </h2>
    </section>


    <!-- Content page -->
    <section class="bg0 m-t-100 p-b-120">
        <div class="container">
            <div class="row p-b-148">
                <div class="col-md-7 col-lg-8">
                    <div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
                        <h3 class="mtext-111 cl2 p-b-16">
                            {{__('messages.frontend.about.our_story')}}
                        </h3>
                ...
                <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                    <div class="how-bor1 ">
                        <div class="hov-img0">
                            <img src="{{ asset('frontend-assets/images/about-01.jpg') }}" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="order-md-2 col-md-7 col-lg-8 p-b-30">
                    <div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
                        <h3 class="mtext-111 cl2 p-b-16">
                            {{__('messages.frontend.about.our_mission')}}
                        </h3>
                ...
                <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                    <div class="how-bor2">
                        <div class="hov-img0">
                            <img src="{{ asset('frontend-assets/images/about-02.jpg') }}" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
