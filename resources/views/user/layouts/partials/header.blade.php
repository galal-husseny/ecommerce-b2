...
<header>
                                ...
                                @auth('web')
                                    ...
                                    <form method="POST" action="{{ route('users.logout') }}">
                                        ...
                                        <li><a href="route('users.logout')"
                                                ...
                                                this.closest('form').submit();"> {{__('user.auth.logout')}} </a>
                                        </li>
                                    </form>
                                @else
                                    <li><a href="{{ route('users.login') }}"> {{__('user.auth.log_in')}} </a></li>
                                    <li><a href="{{ route('users.register') }}"> {{__('user.auth.register')}} </a></li>
                                    <li><a href="{{ route('sellers.index') }}"> {{__('user.header.seller_account')}} </a></li>
                                @endauth
                            </ul>
    ...
    <div class="menu-mobile">
        ...
        <ul class="main-menu-m">
            ...
            <li>
                <a href="product.html">{{ __('user.header.shop') }}</a>
            </li>
            ...
            <li>
                <a href="blog.html">{{ __('user.header.blog') }}</a>
            </li>

            <li>
                <a href="about.html">{{ __('user.header.about') }}</a>
            </li>

            <li>
                <a href="contact.html">{{ __('user.header.contact') }}</a>
            </li>
        </ul>
    </div>
    ...
    <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
        <div class="container-search-header">
            ...
            <form class="wrap-search-header flex-w p-l-15">
                ...
                <input class="plh3" type="text" name="search" placeholder="{{ __('user.header.search')}}">
            </form>
