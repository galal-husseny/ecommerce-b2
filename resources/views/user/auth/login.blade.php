...
@section('content')
    @parent
    <div class=""
        style="background-image: url({{ asset('frontend-assets/images/about-02.jpg') }}); height: 100vh; background-size: cover;">
        <div class="container">
            <div class="bg-light m-lr-auto size-210 bor10 ">
                ...
                <form method="POST" action="{{ route('users.login') }}">
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent">
                        <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" id="email" type="email"
                            name="email"
