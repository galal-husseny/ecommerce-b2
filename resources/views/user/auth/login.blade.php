...
@section('content')
    ...
    <div class="" style="background-image: url({{ asset('frontend-assets/images/about-02.jpg') }}); height: 100vh; background-size: cover;">
        {{-- <div class="container p-t-40 ">
            <div class="bg-light m-lr-auto size-210 bor10 w-full-md m-b-50 m-t-50" style="margin-top: 100px">

                <!-- Logo desktop -->
                <a href="#"  style="margin-left: 30%">
                    <img src="{{ asset('frontend-assets/images/icons/logo-01.png') }}" alt="IMG-LOGO" class="my-5">
                </a>
