                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('sellers.coupons.store') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="max_discount_value" class="form-control"
                                                id="max_discount_value" value="{{ old('max_discount_value') }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="start_at" class="form-control" id="start_at" value="{{ old('start_at') }}" min="{{ date('Y-m-d') }}" max="{{ date('Y-m-d', strtotime('+4 month')) }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="end_at">{{ __('seller.add_coupon.end_at') }}</label>
                                            <input type="date" name="end_at" class="form-control" id="start_at" value="{{ old('end_at') }}" min="{{ date('Y-m-d') }}" max="{{ date('Y-m-d', strtotime('+7 month')) }}">
                                        </div>
                                    ...
                                    <div class="card-footer ">
                                        <button type="submit" class="button-general w-50">
                                            {{ __('seller.add_coupon.submit') }} </button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card-body -->
